package com.example.TintWiz.jwt;
...
//    }
        ...
        http    .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .requestMatchers("/user/**","/assets/**","/articles/**","/product/**")
                .permitAll()
                .anyRequest()
                .authenticated()
                )
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","http://10.4.2.1:3000"));
